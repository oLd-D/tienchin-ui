        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="客户年龄" prop="age">
              <el-input-number v-model="form.age" :min="6" :max="100" placeholder="客户年龄"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const {
  ...
  clue_apply_to,
  sys_user_sex,
} = proxy.useDict("clue_status", "clue_type", "clue_apply_to", "sys_user_sex");
...
function handleUpdate(row) {
  reset();
  const clueId = row.clueId || ids.value;
  getCourse(clueId).then(response => {
