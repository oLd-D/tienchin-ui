  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="最低价格" prop="minPrice">
        <el-input-number v-model="queryParams.minPrice" :precision="2"
                         :step="100" :min="0" placeholder="最低价格"/>
      </el-form-item>
      <el-form-item label="最高价格" prop="maxPrice">
        <el-input-number v-model="queryParams.maxPrice" :precision="2"
                         :step="100" :min="0" placeholder="最高价格"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程编号" align="center" :show-overflow-tooltip="true" width="080" prop="courseId"/>
      <el-table-column label="课程类型" align="center" width="80">
        <template #default="scope">
          <dict-tag :options="course_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
      <el-table-column label="课程名称" align="center" :show-overflow-tooltip="true" width="100" prop="name"/>
      <el-table-column label="课程价格" align="center" :show-overflow-tooltip="true" width="150" prop="price"/>
      <el-table-column label="适用人群" align="center" width="80">
        <template #default="scope">
          <dict-tag :options="course_apply_to" :value="scope.row.applyTo"/>
        </template>
      </el-table-column>
      <el-table-column label="课程信息" align="center" :show-overflow-tooltip="true" width="150" prop="info"/>
      <el-table-column label="课程备注" align="center" :show-overflow-tooltip="true" width="150" prop="remark"/>
      <el-table-column label="课程创建时间" align="center" width="160">
        <template #default="scope">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="courseRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="课程价格" prop="price">
              <el-input-number style="width: 100%" v-model="form.price" :precision="2"
                               :step="0.1" :min="0" placeholder="课程价格"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="适用人群" prop="applyTo">
        ...
        <el-form-item label="课程简介" prop="info">
          <el-input v-model="form.info" placeholder="请输入课程简介" type="textarea"/>
        </el-form-item>
      </el-form>
      <template #footer>
...
const data = reactive({
  ...
  rules: {
    ...
    applyTo: [{required: true, message: "课程适用人群不能为空", trigger: "blur"}],
  }
});
